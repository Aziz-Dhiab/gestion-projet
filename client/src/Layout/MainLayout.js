            ...
            <Layout style={{ minHeight: "90vh" }}>
                <Sider width={300} style={{ background: "#fff" }}>
                    ...
                    >
                        ...
                        <AppProtectedComponent key="user" title="Users" component={SubMenu} name='user' type='menu'>
                        ...
                        <AppProtectedComponent key="resource" title="Projects" component={SubMenu} name='resource' type='menu'>
                            <Menu.Item key="resource-add">
                                <Link to="/resources/add">Add Project</Link>
                            </Menu.Item>
                            <Menu.Item key="resource-list">
                                <Link to="/resources/list">Project List</Link>
                            </Menu.Item>
                    </AppProtectedComponent>
                        <AppProtectedComponent key="permission" title="Phases" component={SubMenu} name='permission' type='menu'>
